    ...
    <div>
      ...
      <p>
        <Trans i18nKey="Contents.P13">
          ...
          control your data and produce much more interesting visualizations.
          Get ready to advance to level three, where you'll learn more
          interesting NRQL skills including filters, facet cases, histogram,
          apdex, filtering to eventTypes, overriding values, and extrapolation.
        </Trans>
      </p>
      <p>
