    ...
    <div>
      ...
      <p>
        <Trans i18nKey="Contents.P3">
          It's also easy to specify time ranges relative to <em>now</em>. You
          can do this with keywords like <code>day</code>, <code>week</code>,{' '}
      ...
      <p>
        <Trans i18nKey="Contents.P4">
          Here are some sample queries that demonstrate relative time ranges.
          Note that when specifying a relative time, you need to include the
          keyword <code>ago</code>.
        </Trans>
      </p>
      <SampleQuery
      ...
      <p>
        <Trans i18nKey="Contents.P5">
          We're getting further control of our data now. Adding a time frame to
          a query lets us define exactly which window of data we want to see.
        </Trans>
      </p>

      <p>
        <Trans i18nKey="Contents.P6">
          These controls let us zero in on the data of interest by defining
          where the data should start and end. In our examples, we saw that we
          can easily choose the window and use common terms like{' '}
          <code>week</code>, <code>day</code>, <code>hour</code>,{' '}
          <code>minute</code>, and their plurals. You can even use{' '}
          <code>month</code> and <code>year</code> if you're storing that much
          data in New Relic.
        </Trans>
      </p>
    </div>
