    ...
    <div>
      ...
      <p>
        <Trans i18nKey="Contents.P2">
          In any scenario you could use <code>LIKE</code>, you now have the
          option to use <code>RLIKE</code>, and provide corresponding Regex in
      ...
      <p>
        <Trans i18nKey="Contents.P3">
          You can also do simple matching. For instance, maybe you want to match
          a value that starts with a given letter or word.
        </Trans>
      </p>
      <SampleQuery
      ...
      <p>
        <strong>
          <Trans i18nKey="Contents.P5">
            ...
            performant than <code>LIKE</code>. Only use it when{' '}
            <code>LIKE</code> and other filtering functionality does not fit
            your needs.
          </Trans>
        </strong>
      </p>
      ...
      <p>
        <Trans i18nKey="Contents.P6">
          ...
          possibilities. If you are already a Regex guru, you know the power
          this adds to NRQL. But if you're not, don't worry! There are tons of
          Regex resources available to reference online.
        </Trans>
      </p>
    </div>
  );
