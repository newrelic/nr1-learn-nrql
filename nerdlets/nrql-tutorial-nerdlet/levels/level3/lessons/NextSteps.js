    ...
    <div>
      ...
      <p>
        <Trans i18nKey="Contents.P2">
          In this section we explored specific, powerful NRQL functionality.
          These skills will undoubtedly serve you next time you're in the
          trenches, diving into the nitty-gritty of your data.
        </Trans>
      </p>
      <p>
      ...
      <p>
        <Trans i18nKey="Contents.P5">
          You're now a Level 3 NRQL expert! Believe it or not, there are even
          more features and functions we want to showcase in the next section.
        </Trans>
      </p>
    </div>
  );
