...
export default function AggregateQuery4() {
  return (
    <div>
      ...
      <h2>
        <Trans i18nKey="Contents.H1">Standard Deviation and Variance</Trans>
      </h2>
      <p>
        <Trans i18nKey="Contents.P2">
          Standard deviation mesaures the amount of variation or dispersion
          within a set of values. It uses a scale from low (values close to the
          average) to high (values far from the average). The{' '}
          <code>stddev()</code>
          function lets us look between the lines of averages and understand
          what values are reported on a deeper level. In this example, we
          compare standard deviation of transaction response time ("duration")
          for the last day to the previous day.
        </Trans>
      </p>
      <SampleQuery
      ...
      <h2>
        <Trans i18nKey="Contents.H2">Facet Bucketing</Trans>
      </h2>
      <p>
        <Trans i18nKey="Contents.P4">
          ...
          <code>FACET buckets()</code>. This function simplifies grouping data
          for any aggregation function. It takes three arguments:
        </Trans>
      </p>
      <p>
      ...
      <p>
        <Trans i18nKey="Contents.P6">
          ...
          that make specific volumes of database calls. So, we specify the
          bucket attribute as <code>databaseCallCount</code>, set the ceiling at
      ...
      <p>
        <Trans i18nKey="Contents.P7">
          ...
          aggregation ability is missing from NRQL, let your account team know.
          We are always looking for the next killer functionality our customers
          need.{' '}
        </Trans>
      </p>
    </div>
