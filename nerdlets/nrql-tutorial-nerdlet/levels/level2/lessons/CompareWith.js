    ...
    <div>
      ...
      <p>
        <Trans i18nKey="Contents.P2">
          We use <code>SINCE</code> and <code>UNTIL</code> to define our period
          of interest. Then, we denote the time period we'd like to compare
          against with a <code>COMPARE WITH [time period] AGO</code> clause
          containing a relative offset value.
        </Trans>
      </p>
      ...
      <p>
        <Trans i18nKey="Contents.P4">
          ...
          . This creates a line chart of the comparison, allowing you to
          visualize how this period compares to recent data, and track it over
          time.
        </Trans>
      </p>
      ...
      <p>
        <Trans i18nKey="Contents.P6">
          Comparisons can quickly answer questions about what's happening in
          your applications. Are different sales, performance, MTTR, or error
          values up or down compared to last week? And, if you are investigating
          an issue, comparing aperiod of problemantic performance to a period of{' '}
