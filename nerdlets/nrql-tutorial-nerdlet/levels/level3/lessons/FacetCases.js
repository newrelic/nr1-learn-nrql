  ...
  return (
    <div>
      <p>
        ...
        As you learned in previous lessons, <code>FACET</code> is a great way to
        both segment your data, and understand it from differently grouped
        ...
        into groups based on the values of provided attributes. But what if you
        wanted to group multiple values together, such as HTTP response codes
        200, 201, etc.?
        </Trans>
      </p>
      <p>
      ...
      <p>
        ...
        As you can see, these groupings are useful but difficult to read. Let's
        clean them up using something we learned in level 2 of this course:
        </Trans>
      </p>
      <SampleQuery
      ...
      <p>
        ...
        <code>FACET CASES()</code> allows us to match and group attributes with
        mulitple, interesting values we want combined. There are many useful
        scenarios for this functionality. It's also even more powerful when
        custom data is tagged onto your transaction data, allowing you more
        granularity and control in navigating and grouping data.
        </Trans>
      </p>
    </div>
  );
