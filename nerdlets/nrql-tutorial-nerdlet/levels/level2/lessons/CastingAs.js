    ...
    <div>
      ...
      <p>
        <Trans i18nKey="Contents.P2">
          ...
          for you and your team(s) to understand exactly what a chart
          represents.{' '}
        </Trans>
      </p>
      ...
      <p>
        <Trans i18nKey="Contents.P3">
          ...
          dashboards, it's important to clearly label your data. This ensures
          zero ambiguity for anyone viewing your widgets, billboards, line
          charts or tables.
        </Trans>
      </p>
      <p>
        <Trans i18nKey="Contents.P4">
          We'll refer back to this in upcoming examples about grouping, to
          explore how <code>AS</code> can create clean result sets in more
          advanced scenarios too.
        </Trans>
      </p>
    </div>
  );
