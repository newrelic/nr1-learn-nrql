...
export default function Links() {
  return (
    <div className="ResourcesPage">
      ...
      <p><Trans i18nKey={"Contents.P3"}>The official documentation for NRQL from the New Relic docs site.</Trans></p>
      ...
      <p>
        <Trans i18nKey={"Contents.P4"}>A selection of tutorials on some of the more advanced NRQL features.</Trans>
      </p>
    </div>
  );
}
