    ...
    <div>
      <p>
        <Trans i18nKey="Contents.P1">
          ...
          <code>*</code>), and division (<code>/</code>) on both numeric
          attribute values, and results of aggregator functions.
        </Trans>
      </p>
      <p>
        <Trans i18nKey="Contents.P2">
          ...
          time (as <code>databaseDuration</code>). But what if we want to
          compute the average time spent outside of database processing? Well,
          let's start by calcuating that value for each event in our data set.
        </Trans>
      </p>
      ...
      <p>
        <Trans i18nKey="Contents.P3">
          ...
          duration of transactions without the database time? Conveniently, we
          can do the arithmetic within the function:
        </Trans>
      </p>
      ...
      <p>
        <Trans i18nKey="Contents.P5">
          New Relic reports timings as part of your events, so you can use them
          to calculate interesting data points, or even generate percentage
          results.{' '}
        </Trans>
      </p>
      <p>
        <Trans i18nKey="Contents.P6">
          You can further maximize the power of basic mathematics by doing
          things like timing custom actions or events, or sending custom data.
          For instance, an e-commerce platform that reports data about order
          sizes, which transactions were successful orders, and payment methods
          could calculate values such as the conversion rate of orders vs.
