    ...
    <div>
      <p>
        <Trans i18nKey="Contents.P1">
          Welcome to Level 3. Thanks for sticking with us! We hope seeing
          example queries and explanations in the context of your own data helps
          you better understand how to transform data into powerful visuals.
          (Try queries from this course on different event types in your own
          account(s) to really understand their power!)
        </Trans>
      </p>
      <p>
